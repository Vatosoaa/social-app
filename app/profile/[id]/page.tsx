  ...
  return (
    <ProfilePublic
      targetUser={{
        ...
        gender_pronouns: targetUser.gender_pronouns || null,
        relationship_status: targetUser.relationship_status || null,
        languages: targetUser.languages || null,
        job_title: targetUser.job_title || null,
        skills: targetUser.skills || null,
        phone: targetUser.phone || null,
        hometown: targetUser.hometown || null,
        website: targetUser.website || null,
        social_linkedin: targetUser.social_linkedin || null,
        hobbies: targetUser.hobbies || null,
        interests: targetUser.interests || null,
